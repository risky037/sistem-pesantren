        ...
        <UstadzLayout>
            ...
            <div className="space-y-6">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 leading-tight">Edit Materi Ajar</h1>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8 max-w-2xl">
                    <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <InputLabel htmlFor="file" value="Upload File Baru" />
                                <input 
                                    id="file"
                                    type="file" 
                                ...
                                {materi.original_file_name && (
                                    <p className="text-xs text-slate-500 mt-2">File saat ini: <span className="font-medium">{materi.original_file_name}</span></p>
                                )}
                            </div>
                            <div>
