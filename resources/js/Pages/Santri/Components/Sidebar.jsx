...
export default function Sidebar({ open, onClose }) {
    ...
    return (
        <>
            ...
            <aside
                className={`
                    fixed top-0 left-0 z-30 h-full w-64 bg-emerald-900 text-white flex flex-col
            ...
            >
                {/* Logo */}
                <div className="flex items-center gap-3 px-5 py-4 border-b border-emerald-700 bg-emerald-800">
                    <img
                        src="/logo.webp"
                    ...
                    <span className="text-base font-bold tracking-wide leading-tight">
                        Pesantren <br />
                        <span className="text-emerald-300 text-xs font-normal">Portal Santri</span>
                    </span>
                </div>
                ...
                <div className="px-3 py-4 border-t border-emerald-700 bg-emerald-800 space-y-1">
                    <Link
                        href={route('profile.edit')}
                        className="flex items-center gap-3 px-4 py-3 rounded-lg text-emerald-200 hover:bg-emerald-700 hover:text-white font-medium transition-all duration-150"
                    >
